...
export default function HomePage() {
  ...
  const renderedPaackages = featuredPackages.map((p) => {
    return (
      <div
        key={p.name}
      ...
      >
        <div className="flex flex-col gap-1 border-bottom border-gray-400">
          ...
          <div className="text-xm text-gray-500">{p.description}</div>
  ...
  return (
    <div className="container py-12 space-y-8">
      ...
      <div className="mx-auto grid grid-cols-4 mx-w-[900px] items-stretch gap-4">
        {renderedPaackages}
      </div>
    </div>
  );
